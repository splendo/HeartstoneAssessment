...
* Create an API allowing you to get card information for legendary deathrattle cards
...
* how you handle async calls
* clean code
* relevant design patterns
* javascript best practices  
* UI should remain responsive during content loading
* should you use 3rd party libraries please motivate your choice
* unit tests
