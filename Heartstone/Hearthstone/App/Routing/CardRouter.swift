...
internal final class CardRouter {
    ...
    internal func routeToCardDetails(cardSets: [HearthstoneCardSet], selectedIndexPath: IndexPath) {
    ...
    internal func routeToFilters(availableFilters: [HearthstoneFilter],
                                 activeFilters: HearthstoneActiveFilters,
                                 onChange: @escaping (HearthstoneActiveFilters) -> Void) {
